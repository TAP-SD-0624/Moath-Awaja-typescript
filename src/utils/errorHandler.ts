...
export const handleCustomError = (res: Response, status: number, message: string, error: any) => {
    console.error(error);
    res.status(status).json({ message, details: error.message || error });
};
